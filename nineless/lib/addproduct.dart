...
import 'package:nineless/showproduct.dart';
    ...
    return MaterialApp(
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(
            seedColor: Color.fromARGB(255, 253, 160, 0)),
        useMaterial3: true,
      ),
      home: addproduct(),
    );
    ...
    return Scaffold(
      ...
      body: Container(
        decoration: const BoxDecoration(
          color: Color.fromARGB(255, 231, 236, 197), // สีพื้นหลัง
        ),
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor:Color.fromARGB(218, 252, 186, 5), // สีพื้นหลัง (พื้นหลังของปุ่ม)
                      foregroundColor:
