...
import 'package:nineless/showfiltertype.dart';
    ...
    return MaterialApp(
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(
            seedColor: Color.fromARGB(255, 242, 121, 0)),
        useMaterial3: true,
      ),
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'ประเภทสินค้า',
          style: TextStyle(
              color: Color.fromARGB(235, 0, 0, 0)), // กำหนดสีของข้อความ
        ),
                            ...
                            child: Center(
                              child: Column(
                                children: [
                                  ...
                                  Icon(
                                    Icons.shopping_bag, // ไอคอนรถเข็น
                                    size: 22, // ขนาดของไอคอน
                                    color: Color.fromARGB(255, 247, 161, 3), // สีของไอคอน
                                  ),
                                ],
                              ),
                            ),
